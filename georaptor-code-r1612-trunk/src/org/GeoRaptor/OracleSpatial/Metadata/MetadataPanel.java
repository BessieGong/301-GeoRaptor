...
public class MetadataPanel extends javax.swing.JDialog {
                          ...
                          boolean modal) 
    {
        ...
        RowFilter<MetadataTableModel,Integer> cbFilter = new RowFilter<MetadataTableModel,Integer>() {
            public boolean include(Entry<? extends MetadataTableModel, ? extends Integer> entry) {
                MetadataTableModel tableModel = entry.getModel();
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if ( OK ) {
            ...
            //
            String ignore = this.metadataTM.readMetadataIntoTable(this.conn,this.userName,this.cbAllSchemas.isSelected());
    ...
    private void btnReloadConnectionsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReloadConnectionsActionPerformed
        ...
        //
        this.cmbConnections.setModel(this.dbConnections.getComboBoxModel(null));
    ...
    throws Exception 
    {
     ...
     private void populateUserWidgets(MetadataEntry _mEntry) 
     {
         ...
         this.cmbGeoColumns.setModel(new DefaultComboBoxModel(new String[]{this.columnName}));
     ...
     { 
        ...
        this.cmbGeoColumns.setModel(new DefaultComboBoxModel(tableGeometryColumns.toArray(new String[0])));
    ...
    class MetadataTableModel extends DefaultTableModel  
    {
                                            ...
                                            boolean          _allSchemas)
        {
            ...
            int cacheBefore = this.cache.size();
