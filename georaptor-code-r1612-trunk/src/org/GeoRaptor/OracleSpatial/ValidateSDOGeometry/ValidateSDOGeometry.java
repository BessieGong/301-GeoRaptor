...
public class ValidateSDOGeometry extends JDialog implements Observer 
{
    ...
    private JComboBox cmbKeyColumns;
    private JLabel lblGeomColumn;
    private JComboBox cmbGeoColumns;
    ...
    private void createDisplayLayer(String geoColumn) 
    {
        try {
            ...
            this.validationLayer.getStyling().setPointColor(Tools.getRandomColor());
            this.validationLayer.getStyling().setLineColor(Tools.getRandomColor());
            ...
            this.validationLayer.getStyling().setShadeColor(Tools.getRandomColor());
    ...
    private void showSingleFeatureErrors(ActionEvent e) 
    {
        ...
        if ( geom == null ) {
            ...
            if ( errorGeoms != null ) {
                ...
                Iterator iter = errorGeoms.keySet().iterator();
                while (iter.hasNext() ) {
