           ...
           extends DefaultTraversablePanel 
{
    ...
    private static PreferencesPanel classInstance;
    private Preferences prefs = null;

    protected ResourceBundle rBundle = ResourceBundle.getBundle("org.GeoRaptor.resource.PreferencesPanel", Locale.getDefault());
    ...
    private JComboBox cmbNewLayerPosition = new JComboBox(
    ...
    private JFormattedTextField tfNullInteger = new JFormattedTextField(new JFormattedTextField(NumberFormat.getIntegerInstance()));
    ...
    private JComboBox cmbShapePolygonOrientation = 
        new JComboBox(
            new DefaultComboBoxModel(
                new String[] { 
                    Constants.SHAPE_POLYGON_ORIENTATION.ORACLE.toString(), 
    ...
    public static PreferencesPanel getInstance() {
        if (PreferencesPanel.classInstance == null ) {
            PreferencesPanel.classInstance = new PreferencesPanel();
        }
        return PreferencesPanel.classInstance;
    }
    ...
    {
        sTpMiscellaneous             = rBundle.getString("sTpMiscellaneous");
        sTpSpatialView               = rBundle.getString("sTpSpatialView");
        sTpVisualisation             = rBundle.getString("sTpVisualisation");
        sTpImportExport              = rBundle.getString("sTpImportExport");

        sBtnSRID          = rBundle.getString("sBtnSRID");
        sCbColourDimInfo  = rBundle.getString("sCbColourDimInfo");
        sCbColourDimInfoTT=rBundle.getString("sCbColourDimInfoTT");
        sCbColourSdoGeometry   = rBundle.getString("sCbColourSdoGeometry");
        sCbColourSdoGeometryTT =rBundle.getString("sCbColourSdoGeometryTT");
        sCbMinResolution       = rBundle.getString("sCbMinResolution");
        sCbSchemaPrefix        = rBundle.getString("sCbSchemaPrefix");
        sCbSchemaPrefixTT      = rBundle.getString("sCbSchemaPrefixTT");
        sCbSdoGeomCoordNumbering   = rBundle.getString("sCbSdoGeomCoordNumbering");
        sCbSdoGeomCoordNumberingTT = rBundle.getString("sCbSdoGeomCoordNumberingTT");
        sCbSdoGeometryFormat     = rBundle.getString("sCbSdoGeometryFormat");
        sCbSdoGeometryFormatTT   = rBundle.getString("sCbSdoGeometryFormatTT");
        sCmbSdoGeometryBracketTT = rBundle.getString("sCmbSdoGeometryBracketTT");
        sCmbSdoGeometryVisualFormatTT=rBundle.getString("sCmbSdoGeometryVisualFormatTT");
        sCbRandomRendering           =rBundle.getString("sCbRandomRendering");
        sCbLogSearchStats        = rBundle.getString("sCbLogSearchStats");
        sCmbTOCPositionTT = rBundle.getString("sCmbTOCPositionTT");
        sLblAffix         = rBundle.getString("sLblAffix");
        sLblDefFetchSize  = rBundle.getString("sLblDefFetchSize");
        sLblFeatureColour = rBundle.getString("sLblFeatureColour");
        sLblFeatureColourTT  = rBundle.getString("sLblFeatureColourTT");
        sLblMBRSaveSize      = rBundle.getString("sLblMBRSaveSize");
        sLblMapBackground    = rBundle.getString("sLblMapBackground");
        sLblNewLayerPosition = rBundle.getString("sLblNewLayerPosition");
        sLblPanZoomChange    = rBundle.getString("sLblPanZoomChange");
        sLblRefreshImage     = rBundle.getString("sLblRefreshImage");
        sLblSdoGeometryBracketing   = rBundle.getString("sLblSdoGeometryBracketing");
        sLblSdoGeometryVisualFormat = rBundle.getString("sLblSdoGeometryVisualFormat");
        sLblSearchPixels    = rBundle.getString("sLblSearchPixels");
        sLblTOCPosition     = rBundle.getString("sLblTOCPosition");
        sPnlMbrSource       = rBundle.getString("sPnlMbrSource");
        sDefSRID            = rBundle.getString("sDefSRID");
        sPnlSelections      = rBundle.getString("sPnlSelections");
        sRbLayerMBRIndex    = rBundle.getString("sRbLayerMBRIndex");
        sRbLayerMBRMetadata = rBundle.getString("sRbLayerMBRMetadata");
        sRbPrefix           = rBundle.getString("sRbPrefix");
        sRbSuffix                    = rBundle.getString("sRbSuffix");
        sLblTableCountLimit          = rBundle.getString("sLblTableCountLimit");
        sLblQueryLimit               = rBundle.getString("sLblQueryLimit");
        sLblTableCountLimitTT        = rBundle.getString("sLblTableCountLimitTT");
        sCbSdoNN                     = rBundle.getString("sCbSdoNN");
        sCbSdoNNTT                   = rBundle.getString("sCbSdoNNTT");
        sPnlNullValueSubstitution    = rBundle.getString("sPnlNullValueSubstitution");
        sLblNullString               = rBundle.getString("sLblNullString");
        sLblNullNumber               = rBundle.getString("sLblNullNumber");
        sLblNullInteger              = rBundle.getString("sLblNullInteger");
        sLblNullDate                 = rBundle.getString("sLblNullDate");
        sTfNullStringTT              = rBundle.getString("sTfNullStringTT");
        sTfNullNumberTT              = rBundle.getString("sTfNullNumberTT");
        sTfNullDateTT                = rBundle.getString("sTfNullDateTT");
        sTfNullIntegerTT             = rBundle.getString("sTfNullIntegerTT");
        sCbDbaseNullWriteString      = rBundle.getString("sCbDbaseNullWriteString");
        sCbPrefixWithMDSYS           = rBundle.getString("sCbPrefixWithMDSYS");
        sCbFastPicklerConversion     = rBundle.getString("sCbFastPicklerConversion");
        sCbMapScale                  = rBundle.getString("sCbMapScale");
        sCbNumberOfFeatures          = rBundle.getString("sCbNumberOfFeatures");
        sLblDBFColumnTruncation      = rBundle.getString("sLblDBFColumnTruncation");
        sRbBegin10                   = rBundle.getString("sRbBegin10");
        sRbBegin10TT                 = rBundle.getString("sRbBegin10TT");
        sRbLast10                    = rBundle.getString("sRbLast10");
        sRbLast10TT                  = rBundle.getString("sRbLast10TT");
        sTfQueryLimitTT              = rBundle.getString("sTfQueryLimitTT");
        sLblPreviewImageWidth        = rBundle.getString("sLblPreviewImageWidth");
        sLblPreviewImageHeight       = rBundle.getString("sLblPreviewImageHeight");
        sCbPreviewVertexNumbering    = rBundle.getString("sCbPreviewVertexNumbering");
        sCbPreviewHorizontalLabels   = rBundle.getString("sCbPreviewHorizontalLabels");
        sLblMinMbrAspectRatio        = rBundle.getString("sLblMinMbrAspectRatio");
    }
    ...
    private void setVerifiers() {
              ...
              public boolean verify(JComponent comp) {
                  ...
                  try {
                      if ( ! textField.getText().matches("^[0-9][0-9]*$") ) {
                          throw new NumberFormatException(rBundle.getString("INTEGER_ONLY_DIGITS"));
                      }
                      // This will throw an exception if the value is not an integer
                      int size = Integer.parseInt(textField.getText());
                      if (size < 1 ) {
                          throw new NumberFormatException(rBundle.getString("ERROR_COUNT_SIZE"));
                      }
                  } catch (NumberFormatException e) {
                      Toolkit.getDefaultToolkit().beep();
        ...
        verifyQueryLimit = new InputVerifier() {
              public boolean verify(JComponent comp) {
                  ...
                  try {
                      if ( ! textField.getText().matches("^[0-9][0-9]*$") ) {
                          throw new NumberFormatException(rBundle.getString("QUERY_DIGITS"));
                      }
                      // This will throw an exception if the value is not an integer
                      int size = Integer.parseInt(textField.getText());
                  } catch (NumberFormatException e) {
                ...
                public boolean verify(JComponent comp) {
                    ...
                    try {
                        ...
                        if (size < 100 || size > 1200) {
                            throw new NumberFormatException(rBundle.getString("DIMENSION_SIZE"));
                        }
                    } catch (NumberFormatException e) {
                        Toolkit.getDefaultToolkit().beep();
                        JOptionPane.showMessageDialog(null, e.getMessage(),
                ...
                public boolean verify(JComponent comp) {
                    ...
                    try {
                        ...
                        if (size < 2.0 || size > 10.0) {
                            throw new NumberFormatException(rBundle.getString("MIN_MBR_ASPECT_RATIO"));
                        }
                    } catch (NumberFormatException e) {
                        Toolkit.getDefaultToolkit().beep();
                        JOptionPane.showMessageDialog(null, e.getMessage(),
        ...
        **  *****************************************************************/
        ...
        sldrSearchPixels.addChangeListener(new ChangeListener() {
               ...
               public void sldrSearchPixelsStateChanged(ChangeEvent evt) {
                   lblSearchPixels.setText(String.format(sLblSearchPixels +
                                                         " %3d",
                                                         sldrSearchPixels.getValue()));
        ...
        sldrMBRSaveSize.addChangeListener(new ChangeListener() {
                               ...
                               public void sldrMBRSaveSizeStateChanged(ChangeEvent evt) {
                                   lblMBRSaveSize.setText(String.format(sLblMBRSaveSize +
                                                                        " %3d",
                                                                        sldrMBRSaveSize.getValue()));
        ...
        cbSchemaPrefix.setText("Prefix Initial layer name with schema?");
         ...
         sldrPanZoomChange.addChangeListener(new ChangeListener() {
               ...
               public void sldrPanZoomChangeStateChanged(ChangeEvent evt) {
                   lblPanZoomChange.setText(String.format(sLblPanZoomChange,
                                                          sldrPanZoomChange.getValue()));
    ...
    protected void setPreviewVertexMark(String _markerType) {
        ...
        this.cmbPreviewVertexMark.setModel(PointMarker.getComboBoxModel());  // Underscores in MARKER_TYPE names are replaced with spaces
    ...
    private void tfNullInteger_actionPerformed(ActionEvent e) {
        if (Strings.isEmpty(tfNullInteger.getText()) ) {
            JOptionPane.showMessageDialog(null, 
                                          rBundle.getString("INTEGER_ONLY_DIGITS"),
                                          MainSettings.EXTENSION_NAME,
                                          JOptionPane.ERROR_MESSAGE);
        }   
    }
    ...
    private void tfNullNumber_actionPerformed(ActionEvent e) {
        if (Strings.isEmpty(tfNullNumber.getText()) ) {
            JOptionPane.showMessageDialog(null, 
                                          rBundle.getString("NUMBER_ONLY_DIGITS"),
                                          MainSettings.EXTENSION_NAME,
                                          JOptionPane.ERROR_MESSAGE);
        }           
    }
    ...
    private void btnCorrectMetadata_actionPerformed(ActionEvent e) {
        final Color correctColor =
                JColorChooser.showDialog(this, 
                                         "Spatial properties - Correct Metadata Color",
                                         this.correctColour);
    ...
    private void btnOrphanColour_actionPerformed(ActionEvent e) {
        final Color orphanColor =
                JColorChooser.showDialog(this, 
                                         "Spatial properties - Orphan Metadata Color",
                                         this.orphanColour);
        if (orphanColor != null) {
            SwingUtilities.invokeLater(new Runnable() {
                public void run() {
    ...
    private void btnMissingMetadata_actionPerformed(ActionEvent e) {
        final Color missingColor =
                JColorChooser.showDialog(this, 
                                         "Spatial properties - Missing Metadata Color",
                                         this.missingColour);
    ...
    private void btnHighlightColour_actionPerformed(ActionEvent e) {
        final Color highlightColor =
                JColorChooser.showDialog(this, 
                                         "Spatial properties - Metadata Highlight Color",
    ...
    public void onEntry(TraversableContext tc)
    {
          ...
          throws TraversalException
     {
         ...
         // Can't be changed here: prefs.setMainLayerSplitPos(Constants.VAL_MAIN_LAYER_SPLIT_POS);
