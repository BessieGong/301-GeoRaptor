...
public class ExportPanel2 extends JPanel {
    ...
    private JComboBox      cmbAttributeFlavour = new JComboBox();
    ...
    public String getAttributeFlavour() 
    {
        return this.cmbAttributeFlavour.getSelectedIndex()==-1
               ? (String)this.cmbAttributeFlavour.getItemAt(0)
  ...
  class ExportColumnModel extends AbstractTableModel 
  {
      ...
      public Vector getLoadColumnData(String[] _nameSet) {
      ...
      **/
      ...
      throws Exception
      {
          ...
          try 
          {
              Iterator keyIter = _columns.keySet().iterator();
              int readRow = -1;
              String key = "";
              while (keyIter.hasNext()) {
                  readRow++;
                  key = (String)keyIter.next();  // Get the key.
