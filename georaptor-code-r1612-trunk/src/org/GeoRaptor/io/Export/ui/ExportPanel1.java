...
public class ExportPanel1 extends JPanel {
    ...
    protected JComboBox cmbGeometries = new JComboBox();
    ...
    protected JList lstExportType = new JList(Constants.EXPORT_TYPE.values());
    ...
    public void setGeometryColumns(DefaultComboBoxModel _entries) {
