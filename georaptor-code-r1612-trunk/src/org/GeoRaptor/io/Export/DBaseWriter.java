...
public class DBaseWriter {
    ...
    **/
    ...
    public static javax.swing.DefaultComboBoxModel getXBaseTypesAsCombo() {
        return new javax.swing.DefaultComboBoxModel(new String[] { DBaseWriter.XBASE_TYPES.DBASEIII.toString(), 
