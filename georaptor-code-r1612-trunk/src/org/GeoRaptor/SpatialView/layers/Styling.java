...
import org.GeoRaptor.Constants.TEXT_OFFSET_POSITION;
...
public class Styling {
    ...
    private static final Logger LOGGER = org.geotools.util.logging.Logging.getLogger("org.GeoRaptor.SpatialView.layers.Styling");
    ...
    public Styling(Styling _style) 
    {
        ...
        this.setShadeColor(new Color(_style.getShadeColor(null).getRed(),
                                     this.getShadeColor(null).getBlue(),
                                     this.getShadeColor(null).getGreen(),
                                     this.getShadeColor(null).getAlpha()));
    ...
    public void setRotationTarget(String _rotate) {
        try {
            this.rotationTarget =
                Strings.isEmpty(_rotate) ? Constants.ROTATE.NONE : Constants.ROTATE.valueOf(_rotate.toUpperCase());
        } catch (Exception e) {
    ...
    public void setRotationValue(String _rotationValue) {
        try {
            this.rotationValue =
                Strings.isEmpty(_rotationValue) ? Constants.ROTATION_VALUES.DEGREES : Constants.ROTATION_VALUES.valueOf(_rotationValue.toUpperCase());
        } catch (Exception e) {
    ...
    public void setRotationColumn(String _rotationColumn) {
        if (Strings.isEmpty(_rotationColumn) || _rotationColumn.equalsIgnoreCase("null")) // Because saving to XML can replace null with string "null"
    ...
    public void setLabelOffset(String _lOffset) {
        try {
            this.labelOffset = Strings.isEmpty(_lOffset) 
                               ? 0 
                               : Integer.valueOf(_lOffset).intValue();
        } catch (Exception e) {
            this.labelOffset = 0;
        }
    }
    ...
    public void setLabelColumn(String _labelColumn) {
        if (Strings.isEmpty(_labelColumn) || _labelColumn.equalsIgnoreCase("null")) // Because saving to XML can replace null with string "null"
    ...
    public void setPointColorType(String _colorType) {
        this.pointColorType =
            Strings.isEmpty(_colorType) || _colorType.equalsIgnoreCase("null") ? Styling.STYLING_TYPE.CONSTANT : Styling.STYLING_TYPE.valueOf(_colorType);
    }
     ...
     * @param _columnValue
     * @return Color
     * @history Simon Greener, 8th January 2011, Fixed bug with COLUMN based rendering
     */
    public Color getPointColor(String _columnValue) {
        if (this.isSelectionActive()) {
            ...
            return new Color(this.randomColorGenerator.nextInt(256), this.randomColorGenerator.nextInt(256), this.randomColorGenerator.nextInt(256));
    ...
    public void setPointSizeType(String _sizeType) {
        try {
            this.pointSizeType =
                Strings.isEmpty(_sizeType) ? Styling.STYLING_TYPE.CONSTANT : Styling.STYLING_TYPE.valueOf(_sizeType.toUpperCase());
        } catch (Exception e) {
    ...
    public void setPointType(String _pointType) {
        try {
            this.pointType =
                Strings.isEmpty(_pointType) ? PointMarker.MARKER_TYPES.CIRCLE : PointMarker.MARKER_TYPES.valueOf(_pointType.toUpperCase());
        } catch (Exception e) {
    ...
    **/
    ...
    public void setLineStrokeType(String _strokeType) {
        try {
            this.setLineStrokeType(Strings.isEmpty(_strokeType) ? LineStyle.LINE_STROKES.LINE_SOLID : LineStyle.LINE_STROKES.valueOf(_strokeType.toUpperCase()));
        } catch (Exception e) {
    ...
    public void setMarkVertex(String _mark) {
        try {
            this.setMarkVertex(Strings.isEmpty(_mark) ? Constants.VERTEX_LABEL_TYPE.NONE : Constants.VERTEX_LABEL_TYPE.valueOf(_mark));
        } catch (Exception e) {
    ...
    public void setMarkSegment(String _mark) {
        try {
            this.setMarkSegment(Strings.isEmpty(_mark) ? Constants.SEGMENT_LABEL_TYPE.NONE : Constants.SEGMENT_LABEL_TYPE.valueOf(_mark));
        } catch (Exception e) {
    ...
    **/
    ...
    public void setShadeType(String _shadeType) {
        this.shadeType =
            Strings.isEmpty(_shadeType) || _shadeType.equalsIgnoreCase("null") ? Styling.STYLING_TYPE.NONE : Styling.STYLING_TYPE.valueOf(_shadeType);
    }
    ...
    public void setSelectionLineStrokeType(String _strokeType) {
        this.setSelectionLineStrokeType(Strings.isEmpty(_strokeType) ? LineStyle.LINE_STROKES.LINE_DASH : LineStyle.LINE_STROKES.valueOf(_strokeType));
    }
    ...
    public void setSelectionLineStroke(String _strokeType) {
        try {
            this.setSelectionLineStroke(Strings.isEmpty(_strokeType) ? LineStyle.LINE_STROKES.LINE_SOLID : LineStyle.LINE_STROKES.valueOf(_strokeType.toUpperCase()));
        } catch (Exception e) {
        ...
        try 
        {
            return String.format("<Styling>" +
                                ...
                                this.getLabelPosition().toString(), 
                                 ...
                                 this.getLabelPosition().toString(),
                                String.format("%d", this.getPointSize(4)), this.getPointSizeType().toString(), this.getPointSizeColumn(), 
                                this.getPointColor(null).getRGB(), this.getPointType().toString(), this.getPointColorColumn(),  this.getPointColorType().toString(),
                                String.format("%d", this.getLineWidth()), this.getLineColor(null).getRGB(),this.getLineStrokeType().toString(),this.getLineTransLevel(),this.getLineColorColumn(), this.getLineColorType().toString(),
                                this.getShadeColumn(), this.getShadeType().toString(),this.getShadeColor(null).getRGB(), this.getShadeTransLevel(), 
                                String.format("%d", this.getSelectionPointSize()), String.format("%d", this.getSelectionLineWidth()), this.getSelectionColor().getRGB(), this.getSelectionShadeTransLevel(),
                                String.valueOf(this.getMarkGeoStart()), String.valueOf(this.getMarkGeoPoints()),this.getMarkVertex().toString(),String.valueOf(this.isMarkOriented()), 
                                 this.getSegmentArrow().toString(),this.getMarkLabelPosition().toString(),
