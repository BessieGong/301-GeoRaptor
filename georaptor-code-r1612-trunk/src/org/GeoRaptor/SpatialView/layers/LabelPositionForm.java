...
/*
 * final int newOffset = sldrOffset.getValue() * 5;
        if ( newOffset != prevOffset ) {
System.out.println(prevOffset + "->" + newOffset);
          SwingUtilities.invokeLater(new Runnable() {
              public void run() {
                  ...
                  String s = null;
                  int x = 0, y = 0;
                  int distance = newOffset - prevOffset;
                  for (Enumeration e = bgPosition.getElements(); e.hasMoreElements(); ) {
                      JRadioButton b = (JRadioButton)e.nextElement();
                      s = b.getText();
                      p = b.getLocation();
                      x = p.x; y = p.y;
                      if ( s.endsWith("L") ) x = p.x - distance;
                      if ( s.endsWith("R") ) x = p.x + distance;
                      if ( s.startsWith("T")) y = p.y - distance;
                      if ( s.startsWith("B")) y = p.y + distance;
System.out.println(pnl9Positions.getSize().toString() + " moving " + s + " by " + distance + " from " + p.toString() + " -> (" + x + "," + y +")");
                      b.setLocation(x,y);
                      b.setBorderPainted(false);
                      b.setBackground(Tools.setAlpha(b.getBackground(),0));
    ...
    }//GEN-LAST:event_sldrOffsetStateChanged
*/
