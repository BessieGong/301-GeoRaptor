...
public class SVSpatialLayerProps extends JDialog {
    ...
    private String BORDER_ARROWS = "Arrows";
        ...
        SwingUtilities.invokeLater(new Runnable() {
                public void run() {
                    ...
                    if ( selectionIndex==-1) {
                        ...
                        DefaultComboBoxModel cm = (DefaultComboBoxModel)cmbConnections.getModel();
    ...
    private void queryApply(boolean _reload) {
        if ( this.layer instanceof SVQueryLayer ) {
            ...
            if (this.cmbSdoOperators.getSelectedItem().toString().equals(Constants.SDO_OPERATORS.RELATE.toString()) ) {
                List<String> selectedMasks = Arrays.asList((String[])this.listRelateMasks.getSelectedValues());
