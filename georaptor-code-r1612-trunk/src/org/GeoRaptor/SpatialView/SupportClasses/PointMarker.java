...
public class PointMarker {
    ...
    public static javax.swing.DefaultComboBoxModel getComboBoxModel() {
    ...
    public static Shape donut( double _cx, double _cy, double _oRadius, double _iRadius) 
    {
      ...
      outerShape = new Ellipse2D.Double( (_cx - _oRadius), (_cy - _oRadius), (_oRadius * 2), (_oRadius * 2) );
      innerShape = new Ellipse2D.Double( (_cx - _iRadius), (_cy - _iRadius), (_iRadius * 2), (_iRadius * 2) );
