...
public class SpatialViewProperties 
    ...
    private void initComponents() {
        ...
        cmbAntialiasing.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "NORMAL", "QUALITY", "SPEED" }));
        ...
        cmbAreaUnits.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Sq Meter", "Hectares", "Sq Feet" }));
        ...
        cmbDistanceUnits.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Feet", "Meter" }));
    ...
    private void cmbDistanceUnitsItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmbDistanceUnitsItemStateChanged
      ...
      if ( !Strings.isEmpty(selectedValue) ) {
        Iterator keyIter = unitsOfMeasure.keySet().iterator();
    ...
    private javax.swing.JComboBox cmbAntialiasing;
    private javax.swing.JComboBox cmbAreaUnits;
    private javax.swing.JComboBox cmbDistanceUnits;
            ...
            public void run()
            {
                ...
                try {
                  ...
                  if ( unitsOfArea != null ) {
                      ...
                      Iterator keyIter = unitsOfArea.keySet().iterator();
                      while (keyIter.hasNext()) {
                          i++;
                          String key = (String)keyIter.next();  // Get the next key.
