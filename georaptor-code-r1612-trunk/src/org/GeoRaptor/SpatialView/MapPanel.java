...
import org.GeoRaptor.SpatialView.SupportClasses.Envelope.zoom;
             ...
             KeyListener 
{
            ...
            if ((e.getModifiers() & InputEvent.BUTTON1_MASK) == InputEvent.BUTTON1_MASK) 
            {
                ...
                switch (svo)
                {
                    ...
                    case CREATE_POINT :
                        ...
                        DecimalFormat df = Tools.getDecimalFormatter(Constants.MAX_PRECISION,false);
                ...
                switch (svo)
                {
                    ...
                    case QUERY_POLYGON     :
                      ...
                      switch (svo) 
                      {
                        ...
                        case QUERY_POLYGON:
                          double maxBuffer;
                          maxBuffer = Math.max(this.getPixelSize().getX(), 
                                               this.getPixelSize().getY()) * this.getSearchPixels();
                          presentSpatialSQLForFinalReview(jGeom);
                          break;
                      }
                      // End of operation
    ...
    */
    ...
    private void presentSpatialSQLForFinalReview(final JGeometry _geometry) 
    {
        ...
        STRUCT stGeom = null;
        try {
            stGeom = JGeometry.store(_geometry, conn);
    ...
    {   
      private int    viewFractionDigits  = 0;
