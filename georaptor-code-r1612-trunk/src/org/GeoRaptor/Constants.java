...
public class Constants {
    ...
    public static enum OBJECT_TYPES { TABLE, MATERIALIZED_VIEW, VIEW, ADHOCSQL };
    ...
    public static enum SHAPE_TYPE {
        ...
        public static javax.swing.DefaultComboBoxModel getArcShapeTypeCombo() {
          return new javax.swing.DefaultComboBoxModel(new String[] { 
                    ARC.toString(),        ARCM.toString(),        ARCZ.toString(),
                    MULTIPOINT.toString(), MULTIPOINTM.toString(), MULTIPOINTZ.toString(),
                    POINT.toString(),      POINTM.toString(),      POINTZ.toString(),
                    POLYGON.toString(),    POLYGONM.toString(),    POLYGONZ.toString(),
                    UNDEFINED.toString() } );
        }
    };

    public static enum GEOMETRY_LABEL_POSITION{ FIRST_VERTEX, MIDDLE_VERTEX, END_VERTEX, JTS_CENTROID, SDO_POINT, LABEL_ALONG };
    public static javax.swing.DefaultComboBoxModel getGeometryLabelPositionCombo() {
      return new javax.swing.DefaultComboBoxModel(new String[] { Constants.GEOMETRY_LABEL_POSITION.FIRST_VERTEX.toString(),
    ...
    public static enum SRID_TYPE { UNKNOWN, 
                                   COMPOUND,
                                   ENGINEERING,
                                   GEODETIC_COMPOUND,
                                   GEODETIC_GEOCENTRIC,
                                   GEODETIC_GEOGRAPHIC2D,
                                   GEODETIC_GEOGRAPHIC3D,
                                   GEOGRAPHIC2D,
                                   PROJECTED,
                                   VERTICAL};
    ...
    public static javax.swing.DefaultComboBoxModel getSRIDTypeCombo() {
      return new javax.swing.DefaultComboBoxModel(new String[] { Constants.SRID_TYPE.UNKNOWN.toString(),
                                                                 Constants.SRID_TYPE.COMPOUND.toString(),
                                                                 Constants.SRID_TYPE.ENGINEERING.toString(),
                                                                 Constants.SRID_TYPE.GEODETIC_COMPOUND.toString(),
                                                                 Constants.SRID_TYPE.GEODETIC_GEOCENTRIC.toString(),
                                                                 Constants.SRID_TYPE.GEODETIC_GEOGRAPHIC2D.toString(),
                                                                 Constants.SRID_TYPE.GEODETIC_GEOGRAPHIC3D.toString(),
                                                                 Constants.SRID_TYPE.GEOGRAPHIC2D.toString(),
                                                                 Constants.SRID_TYPE.PROJECTED.toString(),
                                                                 Constants.SRID_TYPE.VERTICAL.toString() });
    }

    public static enum SEGMENT_ARROWS_TYPE { NONE, 
                                             START, 
                                             MIDDLE, 
                                             END, 
                                             END_ONLY };
    ...
    public static enum VERTEX_LABEL_TYPE { NONE, ID, COORD, ID_COORD, ID_CR_COORD, CUMULATIVE_LENGTH, X, Y, ELEVATION, MEASURE  };
    ...
    public static javax.swing.DefaultComboBoxModel getVertexLabelCombo() {
      return new javax.swing.DefaultComboBoxModel(new String[] { "None"               /* Constants.VERTEX_LABEL_TYPE.NONE */, 
                                                                 "<Id>"               /* Constants.VERTEX_LABEL_TYPE.ID */, 
                                                                 "(X,Y[,Z[,M]])"      /* Constants.VERTEX_LABEL_TYPE.COORD */, 
                                                                 ...
                                                                 "(X)"                /* Constants.VERTEX_LABEL_TYPE.X*/,
                                                                 "(Y)"                /* Constants.VERTEX_LABEL_TYPE.Y */,
                                                                 "(Z)"                /* Constants.VERTEX_LABEL_TYPE.ELEVATION */,
                                                                 "(M)"                /* Constants.VERTEX_LABEL_TYPE.MEASURE */
                                                                 });
    }
    
    public static Constants.VERTEX_LABEL_TYPE getVertexLabelType(String _comboText) {
        if ( _comboText.equalsIgnoreCase("None") )               return Constants.VERTEX_LABEL_TYPE.NONE;
        if ( _comboText.equalsIgnoreCase("<Id>") )               return Constants.VERTEX_LABEL_TYPE.ID;
        if ( _comboText.equalsIgnoreCase("(X,Y[,Z[,M]])") )      return Constants.VERTEX_LABEL_TYPE.COORD;
        if ( _comboText.equalsIgnoreCase("<Id> (X,Y[,Z[,M]])") ) return Constants.VERTEX_LABEL_TYPE.ID_COORD;
        if ( _comboText.equalsIgnoreCase("<html>&lt;Id&gt;<BR/>(X,Y[,Z[,M]])</html>") ) return Constants.VERTEX_LABEL_TYPE.ID_CR_COORD;
        if ( _comboText.equalsIgnoreCase("Cumulative Length") )  return Constants.VERTEX_LABEL_TYPE.CUMULATIVE_LENGTH;
        if ( _comboText.equalsIgnoreCase("(X)") )                return Constants.VERTEX_LABEL_TYPE.X;
        if ( _comboText.equalsIgnoreCase("(Y)") )                return Constants.VERTEX_LABEL_TYPE.Y;
        if ( _comboText.equalsIgnoreCase("(Z)") )                return Constants.VERTEX_LABEL_TYPE.ELEVATION;
        if ( _comboText.equalsIgnoreCase("(M)") )                return Constants.VERTEX_LABEL_TYPE.MEASURE;
        return Constants.VERTEX_LABEL_TYPE.NONE;
    }

    public static String getVertexLabelType(Constants.VERTEX_LABEL_TYPE _comboText) {
        if (_comboText == Constants.VERTEX_LABEL_TYPE.NONE)              return "None";
        if (_comboText == Constants.VERTEX_LABEL_TYPE.ID)                return "<Id>";
        if (_comboText == Constants.VERTEX_LABEL_TYPE.COORD)             return "(X,Y[,Z[,M]])";
        if (_comboText == Constants.VERTEX_LABEL_TYPE.ID_COORD)          return "<Id> (X,Y[,Z[,M]])";
        if (_comboText == Constants.VERTEX_LABEL_TYPE.ID_CR_COORD)       return "<html>&lt) return Id&gt) return <BR/>(X,Y[,Z[,M]])</html>";
        if (_comboText == Constants.VERTEX_LABEL_TYPE.CUMULATIVE_LENGTH) return "Cumulative Length";
        if (_comboText == Constants.VERTEX_LABEL_TYPE.X)                 return "(X)";
        if (_comboText == Constants.VERTEX_LABEL_TYPE.Y)                 return "(Y)";
        if (_comboText == Constants.VERTEX_LABEL_TYPE.ELEVATION)         return "(Z)";
        if (_comboText == Constants.VERTEX_LABEL_TYPE.MEASURE)           return "(M)";
        return "None";
    }

    public static enum SEGMENT_LABEL_TYPE { NONE, SEGMENT_LENGTH, CUMULATIVE_LENGTH, BEARING, BEARING_AND_DISTANCE, SEGMENT_ID };
    ...
    public static enum geometrySourceType { SDO_GEOMETRY, JGEOMETRY };
    
    public static enum EXPORT_TYPE { GML, KML, SHP, TAB };
    
    public static javax.swing.DefaultComboBoxModel getExportTypeAsCombo() {
        return new javax.swing.DefaultComboBoxModel(new String[] { Constants.EXPORT_TYPE.GML.toString(),
                                                                   Constants.EXPORT_TYPE.KML.toString(),
                                                                   Constants.EXPORT_TYPE.SHP.toString(),
                                                                   Constants.EXPORT_TYPE.TAB.toString()});
    }

    public static enum XMLAttributeFlavour { OGR, FME, KML, SHP };
    ...
    public static enum renderType { SDO_GEOMETRY, WKT, GML2, GML3, KML, KML2, ICON, THUMBNAIL }

    public static javax.swing.DefaultComboBoxModel getRenderTypeCombo() {
        return new javax.swing.DefaultComboBoxModel(new String[] { Constants.renderType.SDO_GEOMETRY.toString().toUpperCase(),
    ...
    public static enum bracketType { NONE, ELIPSIS, SQUARE, ROUND, ANGLED };
    ...
    public static enum TEXT_OFFSET_POSITION{ TL, TC, TR, CL, CC, CR, BL, BC, BR };
    
    public static enum ROTATION_VALUES { DEGREES, RADIANS };
    
    public static enum ROTATE { BOTH, LABEL, MARKER, NONE };
    
    public static enum MEASURE { AREA, LENGTH, BOTH };

    public static enum SDO_OPERATORS {ANYINTERACT,CONTAINS,COVEREDBY,COVERS,EQUAL,INSIDE,ON,
                                      OVERLAPBDYDISJOINT,OVERLAPBDYINTERSECT,OVERLAPS,RELATE,TOUCH };
    public static javax.swing.DefaultComboBoxModel getSdoOperators() {
        return new javax.swing.DefaultComboBoxModel(new String[] { "SDO_" + Constants.SDO_OPERATORS.ANYINTERACT.toString().toUpperCase(),
    ...
    public static javax.swing.DefaultComboBoxModel getGeometryTypesCombo() {
        return new javax.swing.DefaultComboBoxModel(new String[] { Constants.GEOMETRY_TYPES.UNKNOWN.toString().toUpperCase(),
    ...
    // public static enum layerPositionType { TOP("TOP") = -2, UP(-1),  DOWN(1), BOTTOM(2) };
    public static enum layerPositionType { TOP, UP, DOWN, BOTTOM };
    ...
    **/
    ...
    /**
     * Name of XML elements where spatial layers in view are saved in the spatialXML tag
     */
    ...
    **/
    ...
    public static final String  VAL_SPATIAL_LAYER_XML          = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><GeoRaptor><Version>" + Tools.getVersion() + "</Version>" +
                                                                 "<SpatialPanel><ActiveView>SRID:NULL</ActiveView>" + 
                                                                 "<Views>" +
                                                                 "<View><ID>" + UUID.randomUUID().toString() + "</ID>" +
                                                                       "<Name>" +  SpatialView.createViewName(MainSettings.getInstance().getPreferences().getSRID()) + "</Name>" +
                                                                       "<VisibleName>" +SpatialView.createViewName(MainSettings.getInstance().getPreferences().getSRID())+ "</VisibleName>" +
                                                                       "<SRID>" + MainSettings.getInstance().getPreferences().getSRID()+"</SRID><SRIDType>PROJECTED</SRIDType>" +
                                                                       ...
                                                                       "<Layers></Layers>" +
                                                                 "</View></Views></SpatialPanel></GeoRaptor>";
